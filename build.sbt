  ...
  .settings(
    ...
    Concat.groups := Seq(
      "javascripts/verifyyouridentityforatrust-app.js" ->
        group(Seq("javascripts/show-hide-content.js", "javascripts/verifyyouridentityforatrust.js"))
    ),
    ...
    includeFilter in uglify := GlobFilter("verifyyouridentityforatrust-*.js")
  )
