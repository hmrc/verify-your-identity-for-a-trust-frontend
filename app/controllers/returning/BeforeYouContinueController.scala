...
class BeforeYouContinueController @Inject()(
                                       ...
                                       view: returning.BeforeYouContinueView,
    ...
    implicit request =>
        ...
        relationship.check(request.internalId, utr) flatMap {
          case RelationshipFound =>
            Future.successful(Redirect(controllers.returning.routes.IvSuccessController.onPageLoad()))
    ...
    implicit request =>
      ...
      (for {
        ...
        def onRelationshipNotFound =  {
          ...
          val returningSuccessRedirect = config.returningSuccessUrl
          val returningFailureRedirect = config.returningFailureUrl
