        ...
        request.userAnswers.get(UtrPage).map { utr =>
          ...
          def onRelationshipFound = {
            taxEnrolmentsConnector.enrol(TaxEnrolmentsRequest(utr)) map { _ =>
              ...
              Ok(view(isAgentManagingTrust, utr, true))
          ...
          lazy val onRelationshipNotFound = Future.successful(Redirect(controllers.claim.routes.IsAgentManagingTrustController.onPageLoad(NormalMode)))
